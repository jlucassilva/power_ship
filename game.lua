...
local function createEnemy()
	...
	local spawnPoint = math.random( 4 )

	if ( spawnPoint == 1 ) then
		-- From the top position 1
		local contentWidth = (display.contentWidth/4)/2
		-- print(contentWidth)
		newEnemy.x = ( display.contentWidth/4)/2
		newEnemy.y = -60
	...
	if ( spawnPoint == 2 ) then
		...
		newEnemy.x = ( display.contentWidth/4)+( display.contentWidth/4)/2
		newEnemy.y = -60
		-- newEnemy:setLinearVelocity( math.random( -40,40 ), math.random( 40,120 ) )
		newEnemy:setLinearVelocity( 0, 100 )
	end
	if ( spawnPoint == 3 ) then
		...
		newEnemy.x = ( display.contentWidth/4)*2 +( display.contentWidth/4)/2
		newEnemy.y = -60
		-- newEnemy:setLinearVelocity( math.random( -40,40 ), math.random( 40,120 ) )
		newEnemy:setLinearVelocity( 0, 100 )
	end
	if ( spawnPoint == 4 ) then
		-- From the top position 3
		newEnemy.x = ( display.contentWidth/4)*3+( display.contentWidth/4)/2
		newEnemy.y = -60
		-- newEnemy:setLinearVelocity( math.random( -40,40 ), math.random( 40,120 ) )
		newEnemy:setLinearVelocity( 0, 100 )
	end
...
local function gameLoop()
	if ( cooldown==false and gameOver==false)then
		basicShot()
	end
	createEnemy()
...
local function onCollision( event )
	if ( event.phase == "began" ) then
		...
		elseif ( ( obj1.myName == "specialShoot" and obj2.myName == "enemy") or
		( obj1.myName == "enemy" and obj2.myName == "specialShoot" ))
		then
			-- print( "log..."..obj1.myName)
			-- print( "log..."..obj2.myName)
...
function scene:create( event )
	...
	scoreText = display.newText( uiGroup, "Score: " .. score, 105, -28, native.systemFont, 32 )
	...
	fireSound = audio.loadSound( "audio/greenLaser.wav"  )
	musicTrack = audio.loadStream( "audio/brave_space_explorers.mp3" )
	specialFireSound = audio.loadSound( "audio/spLaser.wav" )
	gameOverSound = audio.loadSound( "audio/error.wav" )
end
